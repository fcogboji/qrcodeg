  ...
  return (
    <main>
      <section className="border-b border-zinc-200 bg-gradient-to-b from-white to-zinc-50 dark:border-zinc-800 dark:from-zinc-950 dark:to-zinc-900">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
          ...
          <p className="mt-4 text-base font-medium text-zinc-800 dark:text-zinc-200">
            ...
            the square pattern phones read. Register or log in to use the generator studio; nothing
            is sent to an external &quot;QR service&quot; — generation runs on this app.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <script src="https://www.faztino.com/embed/widget.js" defer data-api-base="https://www.faztino.com" data-bot-id="cmpipjbqu00013pe2cn0xlada" data-brand="qrcodeg"></script>
      </section>
    </main>
  );
}
